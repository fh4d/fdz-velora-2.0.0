              ...
              '<div class="framer-1ihf2qm" style="filter:grayscale(0);transform:none;opacity:1;">' +
                ...
                '<div class="framer-1fy171d-container" style="opacity:1;"><!--$-->' +
                  '<div style="width:100%;height:100%;position:relative;overflow:hidden">' +
                    '<div style="background:url(\'assets/images/variant-1-63.webp\');background-size:50px 50px;background-repeat:repeat;position:absolute;inset:-25%;width:150%;height:150%;opacity:0.17"></div>' +
                  '</div>' +
                '<!--/$--></div>' +
              '</div>' +
            '</div>' +
